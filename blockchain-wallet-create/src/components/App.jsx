...
class App extends Component {
  state = { account: "", daiTokenMock: "", balance: 0, transactions: [] };
  ...
  async loadBlockchainData() {
    ...
    const daiTokenAddress = "0xA2cF8688e049A4a030F157948611c62239ceFA23";
              ...
              <div className="content mr-auto ml-auto">
                ...
                <form
                  onSubmit={(event) => {
                    ...
                    this.transfer.bind(this)(recipient, amount);
                  }}
                >
