...
Minimal proxy contract (create_forwarder_to in Vyper)
    ...
    - Why is it cheap to deploy contract? uses delegate call
    - Why is constructor not called? delegate call
    - why is the original contract not affected? delegate call

    What is delegate call?
        - Update the state variable in Contract A even when the code lies in Contract B
...
contract PseudoMinimalProxy {
    ...
    constructor(address _masterCopy) public {
        // notice the constructor of master copy is not called
