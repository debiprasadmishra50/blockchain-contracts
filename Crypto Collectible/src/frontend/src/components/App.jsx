...
import { Token as address } from "../contracts/contract-address.json";
import { abi } from "../contracts/Color.json";
import "./App.css";
...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    const contract = new ethers.Contract(address, abi, this.provider.getSigner(0));
